...
function listPopularity(ajax) {
	// clear out all existing list items (if exist) from the 'popularity' list
	...
	while($("popularity").firstChild!=null)
	...
	for(var i=0; i<ranks.length; i++) {
		...
		var text = ranks[i].getAttribute("year") + " : " + ranks[i].firstChild.nodeValue;
		li.innerHTML = text;
